...
const ProjectPage = ({title, imgData, url, repo, tools, description}) => (
        ...
        <div className="project-page">
            ...
            <p>{description}</p>
            <p style={{color:"rgb(145, 36, 134)"}}>Tools<span style={{color:"rgb(222, 124, 4)"}}>_</span></p>
            <p>{tools}</p>
            <div style={styles.links}>
                <a href={url} target="_blank" style={styles.demoLink}><Button style={styles.button}>Live Demo</Button></a>
                <a href={repo} target="_blank" style={styles.demoLink}><Button style={styles.button}>View Code</Button></a>
            </div>
        </div>
)
